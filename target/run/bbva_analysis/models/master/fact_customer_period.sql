    ...
    USE [MASTER_BBVA];
    EXEC('
        create view "DW"."fact_customer_period__dbt_tmp__dbt_tmp_vw" as 
...
EXEC('
            SELECT * INTO "MASTER_BBVA"."DW"."fact_customer_period__dbt_tmp" FROM "MASTER_BBVA"."DW"."fact_customer_period__dbt_tmp__dbt_tmp_vw" 
    OPTION (LABEL = ''dbt-sqlserver'');

        ')

    
    EXEC('DROP VIEW IF EXISTS DW.fact_customer_period__dbt_tmp__dbt_tmp_vw')
    ...
    if EXISTS (
        ...
        WHERE name = 'DW_fact_customer_period__dbt_tmp_cci'
        AND object_id=object_id('DW_fact_customer_period__dbt_tmp')
    )
    DROP index "DW"."fact_customer_period__dbt_tmp".DW_fact_customer_period__dbt_tmp_cci
    CREATE CLUSTERED COLUMNSTORE INDEX DW_fact_customer_period__dbt_tmp_cci
    ON "DW"."fact_customer_period__dbt_tmp"
